...
replace github.com/alibabacloud-go/tea-utils v1.4.5 => github.com/alibabacloud-go/tea-utils v1.4.5

replace github.com/aliyun/alibaba-cloud-sdk-go v0.0.0-20190830085952-7a8078751366 => github.com/aliyun/alibaba-cloud-sdk-go v0.0.0-20190830085952-7a8078751366

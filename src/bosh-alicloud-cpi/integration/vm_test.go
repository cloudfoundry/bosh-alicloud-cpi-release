...
var _ = Describe("integration:vm", func() {
	...
	It("can run the vm lifecycle with slb_server_group", func() {
		By("create vm with slb_server_group")
		in := mock.NewBuilder(`{
			"method": "create_vm",
			"arguments": [
				"be387a69-c5d5-4b94-86c2-978581354b50",
	...
	It("can run the instance lifecycle with ram profile", func() {
		By("create spot instance")
		in := mock.NewBuilder(`{
			"method": "create_vm",
			"arguments": [
